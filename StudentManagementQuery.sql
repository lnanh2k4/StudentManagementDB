...
INSERT INTO Campus(CaID,CaName,CaAddress,CaEmail,CaHotline) VALUES ('FUHN','Hà Nội','Hoa Lac Hi-Tech Park, Km29 Thang Long Avenue, Thach That District, Hanoi','tuyensinhfpt@gmail.com','024 7300 6800'),
																   ('FUQN','Quy Nhơn','An Phu Thinh new urban area (in Dong Da ward and Nhon Binh ward)','Qnuni@fe.edu.vn','0256 7300 999'),
																   ('FUDN','Đà Nẵng','FPT Da Nang urban area, Hoa Hai Ward, Ngu Hanh Son District, Da Nang City','dnuni@fe.edu.vn','0236 730 0999'),
																   ('FUHCM','Hồ Chí Minh','No. 5 Nguyen Gia Thieu, District 3, Ho Chi Minh City (FSB Institute of Management and Technology facility)','daihoc.hcm@fpt.edu.vn','028 7300 5588'),
																   ('FUCT','Cần Thơ','Rau Ram Bridge, Area 6, extended Nguyen Van Cu, An Binh ward, Ninh Kieu district, city. Can Tho','fptu.cantho@fe.edu.vn','0292 7773636')
GO
